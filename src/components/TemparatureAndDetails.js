...
import { formatToLocalTime, iconUrlFromCode } from "../utils/weatherUtils";
...
const TemparatureAndDetails = ({
  ...
  return (
    <div>
      ...
      <div className="flex flex-row items-center mr-14  justify-between text-white py-3">
        <img
          src={iconUrlFromCode(icon)}
          alt=""
          className="sm:w-12 md:w-20"
        />
        <p className="sm:text-lg md:text-5xl">{`${temp.toFixed()}°`}</p>
